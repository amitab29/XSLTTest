...
<!-- Documentum repository attributes. They only need to be on the root
     element (e.g., the topic element).  This only imports the 
     parameter entity. To add the add the attributes, insert the entity
     %dctm-attrs; into the element's ATTLIST declaration.
 -->
<!ENTITY % dctm-d-attrs-dec SYSTEM "dctm-attrs.ent" >
%dctm-d-attrs-dec;
